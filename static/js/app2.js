...
var width = parseInt(d3.select("#line").style("width"));
...
xText
  .append("text")
  .attr("y", 26)
  .attr("data-name", "TotalPayBenefits")
  .attr("data-axis", "x")
  .attr("class", "aText inactive x")
  .text("Overall Pay with Benefits");
...
d3.json("/assets/data/Salaries.csv").then(function(data) {
  // Visualize the data
  visualize(data);
  console.log(data);
});
...
function visualize(theData) {
  ...
  // Part 3: Instantiate the Line chart
  // ====================================
  // This will add the first placement of our data and axes to the line chart
  ...
  function resize() {
    ...
    width = parseInt(d3.select("#line").style("width"));
